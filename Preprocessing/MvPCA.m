...
x_mean = cell(1, num_view);%zeros(dim,num_view,'double');
x_var = cell(1, num_view);%zeros(dim,num_view,'double');
eig_value = cell(1, num_view);%zeros(dim,num_view,'double');
